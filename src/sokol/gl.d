...
Context sgl_make_context(const ContextDesc *);
...
void sgl_load_transpose_matrix(const float *);
void loadTransposeMatrix(const float * m) {
    sgl_load_transpose_matrix(m);
}
void sgl_mult_matrix(const float *);
void multMatrix(const float * m) {
    sgl_mult_matrix(m);
}
void sgl_mult_transpose_matrix(const float *);
