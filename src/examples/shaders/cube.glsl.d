...
/*
    ...
    Cmdline: sokol-shdc -i src/examples/shaders/cube.glsl -o src/examples/shaders/cube.glsl.d -l glsl330:metal_macos:hlsl4 -f sokol_d
...
sg.ShaderDesc cube_shader_desc(sg.Backend backend) {
	sg.ShaderDesc desc;
	switch (backend) {
