...
+/
    ...
    extern (C) bool ComboCallback(scope const(char)* label, scope int* current_item, scope const(
            char)* function(
    ...
    extern (C) bool ComboCallbackEx(scope const(char)* label, scope int* current_item, scope const(
            char)* function(
    ...
    bool SliderScalarEx(scope const(char)* label, int data_type, scope void* p_data, scope const(
            void)* p_min, scope const(
            void)* p_max, scope const(char)* format, int flags) @trusted
    {
    ...
    bool InputScalarEx(scope const(char)* label, int data_type, scope void* p_data, scope const(
            void)* p_step, scope const(
    ...
    extern (C) bool ListBoxCallback(scope const(char)* label, scope int* current_item, scope const(
            char)* function(
            scope void* user_data, int idx) getter, scope void* user_data, int items_count) @trusted
    {
    ...
    extern (C) void PlotLinesCallback(scope const(char)* label, float function(
    ...
    scope const(ImFont_t)* addFontDefault(scope const(ImFontAtlas_t)* self, scope const(
            ImFontConfig_t)* font_cfg) @trusted
    {
    ...
    scope const(ImFont_t)* addFontFromMemoryCompressedBase85TTF(
        scope const(
            ImFontAtlas_t)* self, scope const(char)* compressed_font_data_base85, float size_pixels, scope const(
            ImFontConfig_t)* font_cfg, scope const(
            ushort)* glyph_ranges) @trusted
    {
