...
/*
    ...
    Cmdline: sokol-shdc -i src/shaders/mrt.glsl -o src/shaders/mrt.d -l glsl330:metal_macos:hlsl4:glsl300es:wgsl -f sokol_d
...
*/
__gshared char[294] VS_OFFSCREEN_SOURCE_GLSL330 = [
...
*/
__gshared char[326] FS_OFFSCREEN_SOURCE_GLSL330 = [
...
*/
__gshared char[335] VS_FSQ_SOURCE_GLSL330 = [
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x33,0x30,0x0a,0x0a,0x75,0x6e,
...
*/
__gshared char[315] FS_FSQ_SOURCE_GLSL330 = [
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x33,0x30,0x0a,0x0a,0x75,0x6e,
...
*/
__gshared char[189] VS_DBG_SOURCE_GLSL330 = [
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x33,0x30,0x0a,0x0a,0x6c,0x61,
    0x79,0x6f,0x75,0x74,0x28,0x6c,0x6f,0x63,0x61,0x74,0x69,0x6f,0x6e,0x20,0x3d,0x20,
...
*/
__gshared char[169] FS_DBG_SOURCE_GLSL330 = [
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x33,0x30,0x0a,0x0a,0x75,0x6e,
    0x69,0x66,0x6f,0x72,0x6d,0x20,0x73,0x61,0x6d,0x70,0x6c,0x65,0x72,0x32,0x44,0x20,
...
sg.ShaderDesc dbg_shader_desc(sg.Backend backend) @trusted @nogc nothrow {
	...
	switch (backend) {
		case sg.Backend.Glcore33:
			...
			desc.vs.source = &VS_DBG_SOURCE_GLSL330[0];
			desc.vs.entry = "main";
			desc.fs.source = &FS_DBG_SOURCE_GLSL330[0];
			desc.fs.entry = "main";
...
sg.ShaderDesc fsq_shader_desc(sg.Backend backend) @trusted @nogc nothrow {
	...
	switch (backend) {
		case sg.Backend.Glcore33:
			desc.attrs[0].name = "pos";
			desc.vs.source = &VS_FSQ_SOURCE_GLSL330[0];
			desc.vs.entry = "main";
			...
			desc.fs.source = &FS_FSQ_SOURCE_GLSL330[0];
			desc.fs.entry = "main";
			desc.fs.images[0].used = true;
			desc.fs.images[0].multisampled = false;
			desc.fs.images[0].image_type = sg.ImageType._2d;
...
sg.ShaderDesc offscreen_shader_desc(sg.Backend backend) @trusted @nogc nothrow {
	...
	switch (backend) {
		case sg.Backend.Glcore33:
			...
			desc.vs.source = &VS_OFFSCREEN_SOURCE_GLSL330[0];
			desc.vs.entry = "main";
			...
			desc.fs.source = &FS_OFFSCREEN_SOURCE_GLSL330[0];
			desc.fs.entry = "main";
