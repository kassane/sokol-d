...
/*
    ...
    Cmdline: sokol-shdc -i src/shaders/shapes.glsl -o src/shaders/shapes.d -l glsl330:metal_macos:hlsl4:glsl300es:wgsl -f sokol_d
...
*/
__gshared char[600] VS_SOURCE_GLSL330 = [
...
*/
__gshared char[114] FS_SOURCE_GLSL330 = [
...
sg.ShaderDesc shapes_shader_desc(sg.Backend backend) @trusted @nogc nothrow {
	...
	switch (backend) {
		case sg.Backend.Glcore33:
			...
			desc.vs.source = &VS_SOURCE_GLSL330[0];
			desc.vs.entry = "main";
			...
			desc.fs.source = &FS_SOURCE_GLSL330[0];
			desc.fs.entry = "main";
