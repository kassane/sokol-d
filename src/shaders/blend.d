...
/*
    ...
    Cmdline: sokol-shdc -i src/shaders/blend.glsl -o src/shaders/blend.d -l glsl330:metal_macos:hlsl4:glsl300es:wgsl -f sokol_d
...
*/
__gshared char[116] VS_BG_SOURCE_GLSL330 = [
...
*/
__gshared char[285] FS_BG_SOURCE_GLSL330 = [
...
*/
__gshared char[288] VS_QUAD_SOURCE_GLSL330 = [
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x33,0x30,0x0a,0x0a,0x75,0x6e,
...
*/
__gshared char[114] FS_QUAD_SOURCE_GLSL330 = [
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x33,0x30,0x0a,0x0a,0x6c,0x61,
    0x79,0x6f,0x75,0x74,0x28,0x6c,0x6f,0x63,0x61,0x74,0x69,0x6f,0x6e,0x20,0x3d,0x20,
...
sg.ShaderDesc bg_shader_desc(sg.Backend backend) @trusted @nogc nothrow {
	...
	switch (backend) {
		case sg.Backend.Glcore33:
			...
			desc.vs.source = &VS_BG_SOURCE_GLSL330[0];
			desc.vs.entry = "main";
			desc.fs.source = &FS_BG_SOURCE_GLSL330[0];
			desc.fs.entry = "main";
...
sg.ShaderDesc quad_shader_desc(sg.Backend backend) @trusted @nogc nothrow {
	...
	switch (backend) {
		case sg.Backend.Glcore33:
			...
			desc.vs.source = &VS_QUAD_SOURCE_GLSL330[0];
			desc.vs.entry = "main";
			...
			desc.fs.source = &FS_QUAD_SOURCE_GLSL330[0];
			desc.fs.entry = "main";
